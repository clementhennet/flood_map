...
var lyr_SateliteImage_0 = new ol.layer.Image({
    ...
    attributions: ' ',
                                ...
                                alwaysInRange: true,
                                imageExtent: [11892110.597529, -707715.906621, 11893851.537962, -702928.117820]
                            })
                        });
...
lyr_TrainStations_3.set('fieldLabels', {'NAMOBJ': 'no label', 'FGSSTA': 'no label', 'KLSSTA': 'no label', 'FCODE': 'no label', 'KODKOD': 'no label', 'WILSTA': 'no label', 'DOPSTA': 'no label', 'KMTSTA': 'no label', 'LINSTA': 'no label', 'KONKON': 'no label', 'REMARK': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', });
...
lyr_CiliwungRiver_5.set('fieldLabels', {'NAMOBJ': 'no label', 'TIPSNG': 'no label', 'KLSSNG': 'no label', 'FCODE': 'no label', 'REMARK': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'NAMWS': 'no label', 'NAMDAS': 'no label', 'STATUS': 'no label', 'WMAX': 'no label', 'DBTMAX': 'no label', 'SLPRT': 'no label', 'SHAPE_Leng': 'no label', });
...
lyr_FieldworkAreas_7.set('fieldLabels', {'id': 'no label', 'RW': 'no label', 'RT': 'no label', 'name': 'inline label - always visible', });
